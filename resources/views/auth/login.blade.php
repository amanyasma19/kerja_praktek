...
<head>
    ...
    <title>Login &mdash; SMKS DHARMA KUSUMA CIANJUR</title>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="../assets/img/logo.gif" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; Inven-AA. Made with 💙 by AMANY
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-8 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../assets/img/unsplash/smks.jpg">
